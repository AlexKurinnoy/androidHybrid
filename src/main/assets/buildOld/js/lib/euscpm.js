...
//-----------------------------------------------------------------------------
	...
	ReadPrivateKeyBinary: function(privateKey, password) {
		...
		infoPtr.free();
                    console.log(" this.privKeyOwnerInfo " + this.privKeyOwnerInfo)
...
//-----------------------------------------------------------------------------
	...
	EnvelopDataToRecipientsWithDynamicKey: function(
	    ...
	    console.log("recipientCertificates " + recipientCertificates)
	    console.log("signData " + signData)
	    console.log("appendCert " + appendCert)
	    console.log("data " + data)
	    console.log("asBase64String " + asBase64String)
		if ((typeof data) == 'string')
			data = this.StringToArray(data);
